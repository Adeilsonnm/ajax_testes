<?php
include("menu.php"); //importa o menu
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex align-items-center m-b-20">
                                        <div>
                                            <h1 class="font-bold m-b-0">Cadastro</h1>
                                            <span>Se cadastre para ter acesso ao sistema</span>
                                        </div>
                                    </div>
                                    <form>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="apelido" placeholder="Entre com o Apelido">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="card">
                                            <h4 class="card-title">Fale um pouco de Você</h4>
                                            <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="endereco" placeholder="Entre com o endereço">
                                        </div>
                                        <div class="form-group">
                                            <label for="numero">Número</label>
                                            <input type="number" class="form-control" id="umero" placeholder="s/n">
                                        </div>
                                        <div class="form-group">
                                            <label for="complemento">Complemento</label>
                                            <input type="text" class="form-control" id="complemento" placeholder="Entre com o Complemento">
                                        </div>
                                        <div class="form-group">
                                            <label for="cep">Cep</label>
                                            <input type="number" class="form-control" id="cep" placeholder="Entre com o Cep">
                                        </div>
                                        <div class="form-group">
                                            <label for="bairro">Bairro</label>
                                            <input type="text" class="form-control" id="bairro" placeholder="Entre com o Bairro">
                                        </div>
                                        <div class="form-group">
                                            <label for="cidade">Cidade</label>
                                            <input type="text" class="form-control" id="cidade" placeholder="Entre com a Cidade">
                                        </div>
                                        <div class="form-group">
                                        <label for="cidade">Estado</label>
                                        <select class="select2 form-control custom-select select2-hidden-accessible" id="estado" style="width: 100%; height:36px;" data-select2-id="1" tabindex="-1" aria-hidden="true">
                                            <option data-select2-id="3">Selecine Seu estado</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" class="form-control" id="senha_r" placeholder="Confirme a Senha">
                                        </div>
                                        <button type="submit" class="btn btn-success waves-effect waves-light m-r-10">Cadastrar</button>
                                        <button type="submit" class="btn btn-dark waves-effect waves-light">Limpar</button>
                                    </form>
            ...
            <footer class="footer text-center">
                Todos os direitos reservados a  <a href="#">@adeilsonnogueira</a>.
            </footer>
